 ...
 *
 * This file defines the structure of position-related data that is transferred between different layers of the application, such as the domain layer, application layer, and infrastructure layer. It includes the Position interface, which represents a user's role or position within the organization.
 *
