        ...
        <div className="flex-1 space-y-6 overflow-y-auto px-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1 text-sm text-black">
              <p>
                <span className="font-bold">name</span> — The user&apos;s name
              </p>
              <p>
                <span className="font-bold">abbreviation</span> — The user&apos;s abbreviation
              </p>
              <p>
                <span className="font-bold">permissions</span> — The user&apos;s permission IDs
